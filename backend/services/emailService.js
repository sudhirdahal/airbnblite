...
/* ============================================================================
 * 👻 HISTORICAL GHOST: PHASE 32 (The Gmail Desynchronization)
 * ============================================================================
 * const transporterLegacy = nodemailer.createTransport({
 *   service: 'gmail',
 *   auth: { user: process.env.EMAIL_USER, pass: process.env.EMAIL_PASS }
 * });
 * 
 * THE FLAW: The service was hardcoded to 'gmail', but the environment keys 
 * were configured for Mailtrap. This caused SMTP auth failures (535) and 
 * backend crashes during user registration.
 * 
 * THE FIX: Reverted to host/port configuration to respect the .env manifest.
 * ============================================================================ */
...
exports.sendVerificationEmail = async (email, name, token) => {
  try {
    ...
    console.error('Email Dispatch Failure (SMTP Auth/Network Error):', err.message);
  }
};
